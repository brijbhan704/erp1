				...
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br> We have recorded your request for change in password.
							<br>
							<br> Your new password is: <a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$password}}"</a>
							<br>
							<br> If, however, you did not request for change in password, do get in touch with the team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br> Regards,
