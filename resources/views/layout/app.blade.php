...
<html lang="{{ config('app.locale') }}">
  <head>
    ...
    <link href="{{ asset('vendors/clockpicker.css') }}" rel="stylesheet">
    <link href="{{ asset('vendors/standalone.css') }}" rel="stylesheet">
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <a id="menu_toggle"><i class="fa fa-bars" style="color: #8e0a6b!important;" ></i></a>
      </div>
            <!-- <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('/') }}" class="site_title"><i class="fa fa-user-secret" style="font-size:33px"></i> <span>{{ config('app.name') }}</span></a>
            </div>
 -->
        ...
        <footer style="margin-left:0px !important">
          <div class="pull-right">
            Copyright &copy; {{date('Y')}} <a href="http://erp.com">enterprise.resourse.portal.com</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src="{{ url('/') }}/vendors/clockpicker.js"></script>
