				...
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br>We have recorded your request for resetting your password. As per your request, we have successfully reset your password.
							<br>
                            <br> Your new Password is: <a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$newpass}}"</a>
							<br>
							<br> If, however, you did not request for resetting your password, do get in touch with the support team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br> Regards,
