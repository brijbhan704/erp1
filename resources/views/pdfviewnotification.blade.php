...
<div class="invoice-box">
		<h2 class="invoice">ER-PORTAL </h2><h4>Notification List</h4>
		...
		<tr>
			<td>{{ ++$key }}</td>
			<td class="text">{{\App\Department::where(['id' => $user->department_id])->pluck('department')->first()}}</td>
			<td>{{\App\User::where(['id' => $user->user_id])->pluck('name')->first()}}</td>
			<td>{{\App\Role::where(['id'=> $user->role_id])->pluck('name')->first()}}</td>
