                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="mb-0">{{ __('Approved Expenses') }}</h3>
                               
                            </div>
                            <div class="col-1">
                                <!-- {{url('/') }}/pdfview -->
                               <!--  route('pdfview',['download'=>'pdf']) -->
                                <a href="{{  route('pdfviewApproved',['download'=>'pdf']) }}" class="btn btn-sm btn-success" style="margin-left: 36px;">{{ __('PDF') }}</a>
                            </div>
                            <div class="col-1">
                                <a href="{{route('export/approvedexpense')}}" class="btn btn-sm btn-info">{{ __('CSV') }}</a>
                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <tr>
                        <td>{{ ++$i }}</td>
                        <td><a href="{{ url('approveexpense/'.$expense->expenseId.'/ApprovedExpenseshow')}}">{{ $expense->title }}</a></td>
                        <td>{{ $expense->price }}</td>
                        <td>
                            @if($expense->name)
