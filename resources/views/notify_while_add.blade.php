            ...
            <table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">					
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
                            ...
                            <br>A new <a style="color:#fd890c; text-decoration:none;" href="">{{$type}}</a> has been listed in <a style="color:#fd890c; text-decoration:none;" href="">{{$city_name}}</a>.
                            <br>
                            Please view the details on the app.

                            <br>
                            <br>
							<br> If, however, you did not request to this notification, do get in touch with the support team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br>
							<br> Regards,
