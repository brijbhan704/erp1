				...
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br>We have recorded your request for a forgetten password. As per your request, below is the OTP to reset your password.
							<br>
                            <br> Your new OTP is: <a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$otp}}"</a>
							<br>
							<br> If, however, you did not put in a request for a forgotten password, do get in touch with the support team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br> Regards,
