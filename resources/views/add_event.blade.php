				...
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br> Thanks for registering for <a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$event_name}}"</a> at  <a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$site_name}}"</a> community!
							<br>
                            <br> Below are the few details of the event.
                            <br>
                            <br>Location:<a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$address}}"</a>
							<br>Start Date:<a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$start_date}}"</a>
                            <br>End Date:<a style="color:#fd890c; text-decoration:none; cursor:text;">"{{$end_date}}"</a>
							<br>
							<br> If, however, you did not request to create the event, do get in touch with the support team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br>
							<br> Regards,
