...
<div class="invoice-box">
		<h2 class="invoice">ER-PORTAL </h2><h4>Purchase Order List</h4>
		...
		<tr>
			...
			<td>{{ $item->quantity }}</td>
			<td>{{ $item->price }}</td>
			<td>{{ \App\InventoryCategory::where(['parent_id' => $item->category_id])->pluck('name')->first() }}</td>
			<td>{{ \App\InventoryCategory::where(['id' => $item->subcategory_id])->pluck('name')->first() }}</td>
			<td>{{ $item->date }}</td>
