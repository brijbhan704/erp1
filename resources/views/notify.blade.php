			...
			<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">					
					...
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;"> Dear {{$name}},
							<br>
							<br> Thanks for placing a request to be notified whenever a {{$type}} gets listed in {{$city_name}}.
                            <br>
                            We will be sending you a notification mail as soon as a {{$type}} gets listed.
                            <br>
                            <br>
							<br> If, however, you did not request to this notifiacation, do get in touch with the support team at <a style="color:#fd890c; text-decoration:none;" href="mailto:{{$supportEmail}}">{{$supportEmail}}</a>
							<br>
							<br>
							<br> Regards,
